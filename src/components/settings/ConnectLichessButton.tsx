...
export function ConnectLichessButton() {
  ...
  async function connect() {
    ...
    if (!trimmed) {
      setError("Please enter your Lichess username");
      return;
    }
    ...
    try {
      ...
      fetch("/api/lichess/sync", { method: "POST" }).catch(() => {
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-zinc-500">
        Connect your Lichess account to track ratings, game performance, and discover
